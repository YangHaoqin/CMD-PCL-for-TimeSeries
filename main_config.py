...
if __name__ == "__main__":
    ...
    parser.add_argument('--agent', dest='agent', default='DT2W', type=str,
                        choices=['SFT', 'Offline',
                                 ...
                                 'Mnemonics', 'Inversion', 'GR', 'CMD-PCL'
                                 'FastICARL'],
    ...
    parser.add_argument('--weight_decay', dest='weight_decay', default=0, type=float,
                        help='weight decay')
    parser.add_argument('--dropout', dest='dropout', default=0.3, type=float)
    ...
    parser.add_argument('--seed', dest='seed', default=1236, type=int)
    ...
    parser.add_argument('--lambda_kd_lwf', dest='lambda_kd_lwf', default=10, type=float)
    ...
    parser.add_argument('--lambda_pic', dest='lambda_pic', default=10, type=float, help='对比损失权重')
    parser.add_argument('--num_samples', type=int, default=15, help='Number of Monte Carlo Dropout samples for uncertainty estimation')
    parser.add_argument('--tau', type=float, default=0.5, help='Temperature parameter for PICLoss in contrastive learning')
    ...
    exp_path_1 = args.encoder + '_' + args.data +str(args.seed)
